...
import { Mail, Lock, User, UserCog, Zap, Eye, EyeOff, Loader2, UserPlus } from "lucide-react";
import API from "../api";
...
export default function Signup() {
    ...
    return (
        <div className="min-h-screen bg-[#0f172a] flex items-center justify-center px-4 relative overflow-hidden">
            ...
            <div className="absolute bottom-1/3 left-1/4 w-80 h-80 bg-indigo-600/10 rounded-full blur-[120px]" />
            ...
            <div className="w-full max-w-md relative z-10 animate-slide-up">
                ...
                <div className="glass-card p-8">
                    <div className="mb-6">
                        ...
                        <p className="text-sm text-slate-400">Sign up to start managing your inventory</p>
                    </div>
